...
async def upstream(ups):
    ...
    try:
        ...
        if conf != "now":
            ...
            return
        repo = Repo.init()
        origin = repo.create_remote('upstream', fatime_repo)
        origin.fetch()
        force_update = True
    ...
    try:
        repo.create_remote('upstream', fatime_repo)
    ...
    if conf != "now" and not force_update:
        ...
        await mesaj.respond('`Botunuz 𝐅𝐚𝐭𝐢𝐦𝐞 𝐔𝐬𝐞𝐫𝐛𝐨𝐭 ᥫ᭡ admini tərəfindən yenilənir`')
        return
